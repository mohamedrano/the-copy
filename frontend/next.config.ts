...
const nextConfig: NextConfig = {
  ...
  // Add allowed development origins to prevent cross-origin warnings
  // Set ALLOWED_DEV_ORIGIN environment variable to your Workstations URL
  // Example: https://9002-firebase-the-copy--XXXX.cluster-....dev
        ...
        headers: [
          {
            ...
            value: [
              ...
              // Updated font-src to include external font sources
              ...
              `connect-src 'self' https://apis.google.com https://*.googleapis.com https://identitytoolkit.googleapis.com https://securetoken.googleapis.com https://www.googleapis.com https://*.sentry.io wss: ws: ${devOrigin}`,
  ...
  // Only use webpack customization when explicitly needed
